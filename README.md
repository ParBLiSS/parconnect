...
This library implements a distributed connectivity algorithm for large graphs. It can compute the connected components in the undirected graphs or [http://mathworld.wolfram.com/WeaklyConnectedComponent.html](weakly connected components) in the directed graphs. The algorithm is implemented in `C++11` and `MPI`.
